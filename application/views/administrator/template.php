...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <?php 
            if($this->uri->segment(2)!='home' AND $this->uri->segment(2)!=''){
              ...
              echo "<li class='breadcrumb-item'>Haloo, Selamat Datang Admin!</li>";
            }
          ?>
          </ol>
          </div><!-- /.col -->
  ...
  <footer class="main-footer text-sm">
    <strong>Copyright &copy; 2014-<?php echo date('Y'); ?> <a target='_BLANK' href="http://Diskominfo Pematangsiantar/"><?php echo $iden['nama_website']; ?></a>.</strong>
    All rights reserved.
