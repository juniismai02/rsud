...
<a href="<?php echo base_url().$this->uri->segment(1); ?>" class="brand-link navbar-light">
      <img src="<?php echo base_url(); ?>/asset/logo/admin.png" alt="Admin Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light" style='color:#000'>ADMIN WEB OPD</span>
    </a>
        ...
        <li class="nav-header">MENU UTAMA</li>
          ...
          <li class="nav-item has-treeview">
            ...
            <?php
              ...
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/album'><i class='far fa-circle nav-icon text-success'></i> <p>Album Berita Foto</p></a></li>";
              }
          ...
          <li class="nav-item has-treeview">
            ...
            <p>Modul Kegiatan & Arsip <i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
            <?php
              $cek=$this->model_app->umenu_akses("agenda",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/agenda'><i class='far fa-circle nav-icon text-success'></i> <p>Kegiatan</p></a></li>";
              }
              ...
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/download'><i class='far fa-circle nav-icon text-success'></i> <p>Dokumen</p></a></li>";
              }
          ...
          <li class="nav-header">MENU KELUAR</li>
          <!-- <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
