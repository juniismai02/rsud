...
<link rel="shortcut icon" href="<?php echo base_url(); ?>asset/images/<?php echo favicon(); ?>" />
    ...
    <meta
      ...
      content="Website Resmi Rumah Sakit Umum Daerah (RSUD) dr. Djasamen Saragih Kota Pematangsiantar - Menyajikan Seputar Informasi Rumah Sakit Umum Daerah (RSUD) dr. Djasamen Saragih Kota Pematangsiantar"
    />
    <meta
      name="keywords"
      content="Rumah Sakit Umum Daerah (RSUD) dr. Djasamen Saragih Kota Pematangsiantar, kota pematangsiantar, pemerintah kota pematangsiantar, berita dan topik, informasi, sosialisasi, agenda, direktori kota, fitur"
    />
    ...
    <meta content="Website Resmi Rumah Sakit Umum Daerah (RSUD) dr. Djasamen Saragih Kota Pematangsiantar Pematangsiantar" name="author" />
    ...
    <meta
      ...
      content="Website Resmi Rumah Sakit Umum Daerah (RSUD) dr. Djasamen Saragih Kota Pematangsiantar Pematangsiantar - Menyajikan Seputar Informasi Rumah Sakit Umum Daerah (RSUD) dr. Djasamen Saragih Kota Pematangsiantar Pematangsiantar"
    />
...
<script>
    // Add JavaScript to handle dropdown toggle on mobile devices
    $(document).ready(function() {
    ...
    <style>
      /* Atur tata letak untuk tampilan mobile */
      @media only screen and (max-width: 768px) {
        .minidashboard__body {
          flex-direction: column; /* Tampilkan dalam satu kolom */
        }

        .news3col__col {
          width: 100%; /* Setiap kolom mengambil lebar penuh */
          order: initial; /* Reset urutan */
        }
      }
    </style>
    <!-- DISABILITAS -->
        ...
        <div class="popup-content">
          ...
          <div class="popsosial">
            <div class="popsosial-img">
              <img src="assets/img/main-banner.html" alt="img" />
            </div>
          ...
          <!-- <ul>
            ...
            <li>
              <a href="https://cctv.pematangsiantar.go.id/"
                ><img src="<?= base_url(); ?>template/<?= template(); ?>/assets/img/floatmenu/3.png" alt="img" /><span
                  >CCTV</span
                ></a
              >
            </li>
