            ...
            <div class="row divider py-4">
                <div class="col-lg-6">
                    <div class="copyright-section text-center text-lg-left">
                        © <script>document.write(new Date().getFullYear());</script> Copyright <a href="http://Diskominfo Pematangsiantar" target="_blank">Diskominfo Pematangsiantar</a> | All Rights Reserved
                    </div>
                </div>
                <div class="col-lg-6">
